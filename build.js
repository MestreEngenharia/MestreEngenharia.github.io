...
const SERVICES = [
  ...
  },
  {
    ...
    seoDesc: 'Licenciamento ambiental no IMA/SC (LAP, LAI, LAO), laudos e perícias ambientais, PGRS, PGRSS, PGRCC, MTR, passivo, drenagem e CAR em Itajaí e SC.',
  ...
  },
  {
    ...
    seoDesc: 'Assistente técnico em perícias trabalhistas em Itajaí, Florianópolis e SC: insalubridade, periculosidade, EPI, PGR, LTCAT, quesitos e impugnação de laudos.',
...
<style>
  ...
  .etp .num{flex-shrink:0;width:42px;height:42px;border-radius:50%;background:var(--deep);color:var(--gold-2);display:grid;place-items:center;font-family:'Montserrat',sans-serif;font-weight:800;font-size:1.05rem}
  .etp .etp-body{flex:1;min-width:0}
  .etp .etp-top{display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:4px}
  .etp b{color:var(--ink);font-size:1.02rem}
  .etp p{color:var(--ink-2);font-size:.95rem;margin:0}
  .etp .quem{flex-shrink:0;font-family:'Montserrat',sans-serif;font-size:.66rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase;padding:5px 12px;border-radius:999px;white-space:nowrap}
  .etp .quem.m{background:var(--deep);color:#fff}
  .etp .quem.v{background:var(--gold-soft);color:var(--gold-3,#8a6a15);border:1px solid var(--gold-line)}
  @media(max-width:560px){.etp{padding:16px}.etp .num{width:34px;height:34px;font-size:.92rem}}
...
<section class="section mistbg">
  <div class="wrap">
    ...
    <ol class="etp-list">
      <li class="etp reveal"><span class="num">1</span><div class="etp-body"><div class="etp-top"><b>Triagem técnica</b><span class="quem m">Mestre</span></div><p>Responsável (PF ou PJ), categoria, destinação, tipo construtivo, áreas, datas e declarações do período.</p></div></li>
      <li class="etp reveal d1"><span class="num">2</span><div class="etp-body"><div class="etp-top"><b>Procuração eletrônica no e-CAC</b><span class="quem v">Você assina</span></div><p>Acesso da nossa equipe aos sistemas da obra, sem pedir a sua senha.</p></div></li>
      <li class="etp reveal"><span class="num">3</span><div class="etp-body"><div class="etp-top"><b>CNO e diagnóstico</b><span class="quem m">Mestre</span></div><p>Cadastro ou correção da obra, vinculação de alvará e habite-se, varredura de créditos existentes.</p></div></li>
      <li class="etp reveal d1"><span class="num">4</span><div class="etp-body"><div class="etp-top"><b>Estratégia antes do cálculo</b><span class="quem m">Mestre</span></div><p>Decadência, créditos, fator de ajuste e enquadramento. Só depois a aferição no SERO.</p></div></li>
      <li class="etp reveal"><span class="num">5</span><div class="etp-body"><div class="etp-top"><b>DCTFWeb, DARF ou parcelamento e emissão da CND</b><span class="quem m">Mestre</span></div><p>Transmissão da declaração, guia de pagamento ou parcelamento e a certidão para averbar no cartório.</p></div></li>
    </ol>
